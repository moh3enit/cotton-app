...
class ProductController{
  ...
  //--------------------- Get Sub Cats ---------------------------------------------//
  static Future<MyResponse<Map<String,List<ShProduct>>>> getSubCatProduct(String? categorySlug) async {

    String url = ApiUtil.MAIN_API_URL + ApiUtil.SUB_CATEGORY_PRODUCTS + categorySlug! ;
